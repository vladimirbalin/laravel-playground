...
class Lecture extends Model
{
    ...
    protected $casts = [
        ...
        'content_type_id' => LectureContentTypeEnum::class,
        'payment_type_id' => LecturePaymentTypeEnum::class,
    ];
    ...
    {
        return $this->payment_type_id === LecturePaymentTypeEnum::FREE->value;
    }

    public function isPromo(): bool
    {
        return $this->payment_type_id === LecturePaymentTypeEnum::PROMO->value;
    }
